            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand">Know Your Hospital</div>
                        <!--
                        <a class="navbar-brand" href="#"><img src="<?php echo base_url("public/images/logo.png")?>" class="img-responsive" style="width: 140px; margin-top: -16px;"></a>
                        -->
                    </div>
